...
public class dataBarang extends javax.swing.JDialog {
    ...
    public void cetak() {
        try {
            tabelBarang.print(JTable.PrintMode.FIT_WIDTH, new MessageFormat("Data Transaksi"), null);
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","Kode Produk","Nama Produk","Kategori","Jumlah","Keterangan"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarang.setModel(tabmode);
        String sql = "select * from tb_barang order by kode_produk asc";
        try{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA BARANG KANTOR");
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from tb_barang where kode_produk='"+txtKodePart.getText()+"'";
            try {
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update tb_barang set tanggal=?,kode_produk=?,nama_produk=?,kategori=?,jumlah=?,keterangan=? where kode_produk='"+txtKodePart.getText()+"'";
